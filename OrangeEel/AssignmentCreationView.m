...
-(id)initWithFrame:(CGRect)frame
{
    ...
    if(self){
        ...
        focus1.layer.sublayerTransform = CATransform3DMakeTranslation(5, 0, 0);
        ...
        focus2.layer.sublayerTransform = CATransform3DMakeTranslation(5, 0, 0);
        ...
        focus3.layer.sublayerTransform = CATransform3DMakeTranslation(5, 0, 0);
...
-(BOOL)textFieldShouldReturn:(UITextField *)textField{
    if (textField.tag==199 && textField.text.length>=11) {
        ...
        [saveButton setFrame:CGRectMake(5+self.frame.size.width/2, 70+self.frame.size.height-35, (self.frame.size.width/2)-10, 30)];
        [cancelButton setFrame:CGRectMake(5,70+ self.frame.size.height-35, (self.frame.size.width/2)-10, 30)];
