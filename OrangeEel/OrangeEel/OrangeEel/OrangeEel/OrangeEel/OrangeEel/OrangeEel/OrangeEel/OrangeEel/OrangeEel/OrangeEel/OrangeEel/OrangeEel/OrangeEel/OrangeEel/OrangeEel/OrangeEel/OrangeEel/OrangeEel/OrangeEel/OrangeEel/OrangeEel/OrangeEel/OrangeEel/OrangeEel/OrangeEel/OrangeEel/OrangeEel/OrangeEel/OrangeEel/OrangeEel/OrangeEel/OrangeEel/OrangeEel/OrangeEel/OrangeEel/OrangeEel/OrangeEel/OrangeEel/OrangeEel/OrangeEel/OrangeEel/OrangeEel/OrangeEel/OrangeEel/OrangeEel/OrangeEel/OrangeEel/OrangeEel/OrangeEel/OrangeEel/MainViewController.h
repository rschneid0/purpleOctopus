...
@interface MainViewController : UIViewController <UITableViewDataSource, UITableViewDelegate, UITextFieldDelegate, AssignmentCreatorDelegate, JTCalendarDataSource,PFLogInViewControllerDelegate, PFSignUpViewControllerDelegate>
{
    UITextField* tf;
    UIView* grayView;
